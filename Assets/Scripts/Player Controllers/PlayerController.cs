...
using UnityEngine.Networking;
 ...
 public class PlayerController : NetworkBehaviour 
 {
	...
	public bool lastFacedLeft; //Used for determining which idle state to use
    	...
    	//Called in order after the Awake method on initialization
    	void Start() 
    	{
	...
	//Called every cycle, ignoring framerate
	...
	//Only the server can command clients to run this method
	[ClientRpc]
	...
	//After the server updates all of the clients, then our transform is updated
	...
	[Command]
	void CmdSpriteChange(int sprite)
	{
